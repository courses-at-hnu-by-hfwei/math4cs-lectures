...
\begin{frame}
  \begin{definition}[Order of Elements (元素的阶)]
    ...
    The \red{order} of $a$ is the \blue{smallest} positive integer $r$
    such that \red{$a^{r} = e$}.
...
\begin{frame}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \begin{align*}
        &(a^m)^d = e \\[5pt]
        \uncover<4->{\implies & a^{md} = e \\[5pt]}
        \uncover<5->{\implies & \red{n \mid md} \\[5pt]}
        \uncover<6->{\implies & \frac{n}{(m, n)} \mid \frac{m}{(m, n)}d \\[5pt]}
        \uncover<7->{\implies & \frac{n}{(m, n)} \mid d}
      \end{align*}
    \column{0.50\textwidth}
      \uncover<8->{
        \[
          (a^{m})^{\frac{n}{(m, n)}} = a^{\frac{mn}{(m, n)}} = (a^n)^{\frac{m}{(m, n)}} = e
        \]
      }
  ...
  \begin{definition}[Cyclic Group (循环群)]
    ...
    \[
      \exists a \in G\; G = \red{\langle a \rangle}
        \triangleq \set{a^{r} \mid r \in \Z}
        = \set{\dots, a^{-2}, a^{-1}, a^{0} = e, a, a^{2}, \dots},
    \]
  ...
  \begin{theorem}
    \begin{enumerate}[<+->][(1)]
      ...
      \item Let $G = \set{e, a, a^{-1}, a^2, a^{-2}, \dots}$
        be an \red{infinite} cyclic group.
        \[
          \forall k, l \in \Z\; (a^k = a^l \to k = l).
        \]
      \item Let $G = \set{e, a, a^2, \dots, a^{n-1}}$
        be a \red{finite} cyclic group of order $n$.
        \[
...
\begin{frame}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \begin{center}
        \purple{\boxed{\text{Suppose that $G = \langle a^{k} \rangle$.}}}

        \pause
        \[
          \exists n \in \Z\; (a^{k})^{n} = a^{kn} = a
        \]
        \pause
        \[
          kn = 1 \implies k = \pm 1
    ...
    \column{0.50\textwidth}
      \pause
      \[
        \purple{\boxed{\text{ord}\; a^{r} = \frac{n}{(n, r)}}}
      \]
      \pause
      \begin{align*}
        G = \langle a^{r} \rangle &\iff \text{ord}\; a^{r} = n \\
        &\iff \frac{n}{(n, r)} = n \\
        &\iff (n, r) = 1
      \end{align*}
  \end{columns}
...
\begin{frame}{}
  ...
  \vspace{2em}
  \begin{theorem}[Subgroups of Cyclic Groups]
    Suppose that $G = \langle a \rangle$ is a cyclic group.
    
    \begin{enumerate}[(1)]
      \setlength{\itemsep}{6pt}
      \pause
      \item If $|G| = \infty$, the set of subgroups of $G$ is:
        \[
          \set{\langle a^{d} \rangle \mid d = 0, 1, 2, \cdots}
        \]
      \pause
      \item If $|G| = n$, the set of subgroups of $G$ is:
        \[
          \set{\langle a^{d} \rangle \mid d \text{ is a positive divisor of } n}
        \]
    \end{enumerate}
  \end{theorem}
