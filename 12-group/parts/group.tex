...
\begin{frame}
  \begin{definition}[Group (群)]
    ...
    \begin{description}[<+->][Associativity:]
      ...
      \item[Identity (单位元):]
        \[
          \exists e \in G\; \forall a \in G\; e \ast a = a \land a \ast e = a
        \]
      \item[Inverse (逆元):] Let $e$ be \red{the} identity of $G$.
        \[
          \forall a \in G\; \exists b \in G\; a \ast b = e \land b \ast a = e
        \]
...
\begin{frame}{}
    ...
    \pause
    \[
      (\set{1, -1, \text{\bf i}, -\text{\bf i}}, \times)
    \]
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}
  ...
  \pause
  \[
    \prod_{i=1}^{n} (a a_i) = \prod_{i=1}^{n} a_i
  \]
