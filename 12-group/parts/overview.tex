...
\begin{frame}{}
  \begin{quote}
    ``In mathematics, more specifically algebra,
    \blue{abstract algebra} or \blue{modern algebra}
    is the study of \red{algebraic structures},
    which are \purple{sets} with specific \brown{operations}
  ...
  \vspace{0.80cm}
  \begin{quote}
    ``Algebraic structures include \violet{groups},
    rings, fields, modules, vector spaces,
    lattices, and algebras over a field.''
  \end{quote}
\end{frame}
%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \fig{width = 0.75\textwidth}{figs/group-theory-in-tcs}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}
  \begin{theorem}[Galois Theorem]
    An equation is \blue{solvable} in terms of radicals \red{if and only if}
