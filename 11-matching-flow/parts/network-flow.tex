...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.85\textwidth}{figs/West-network-example}
    \column{0.50\textwidth}
      \fig{width = 0.90\textwidth}{figs/CLRS-network-example}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%g
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.85\textwidth}{figs/flow-value-1}
    \column{0.50\textwidth}
      \fig{width = 0.90\textwidth}{figs/CLRS-flow-19}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%g
  ...
  \begin{definition}[Feasible Flow (可行流)]
    ...
    \begin{description}[Capacity Constraints:]
      ...
      \item[Flow Conservation:]
        \[
          \forall v \in V \setminus \set{s, t}\; f^{+}(v) = f^{-}(v)
        \]
    \end{description}
  \end{definition}
...
\begin{frame}{}
  \begin{columns}
    ...
    \column{0.50\textwidth}
      \pause
      \fig{width = 0.90\textwidth}{figs/CLRS-flow-23}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \vspace{0.80cm}
  \[
    s \sim t \text{ path}: s - v_{1} \;\red{-}\;
      v_{2}\;\red{-}\; v_{3} - t
  \]
  \pause
  \[
    s \sim t \text{ path}: s - v_{2} \;\red{-}\; v_{3} - t
  \]
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{center}
    ...
    \[
      \text{\blue{tolerance} of } P: \min_{e \;\in\; E(P)} \epsilon(e)
    \]
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%g
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.95\textwidth}{figs/CLRS-flow-19}
    \column{0.50\textwidth}
      \pause
      \fig{width = 0.95\textwidth}{figs/CLRS-flow-23}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%g
...
\begin{frame}{}
  \begin{definition}[Source/Sink Cut (割)]
    ...
    \blue{from} a \cyan{source set} $S$ \blue{to} a \cyan{sink set} $T$, where
    \[
      (T = V \setminus S) \land (s \in S) \land (t \in T)
    \]
  \end{definition}
...
\begin{frame}{}
  ...
  \begin{definition}[Capacity of Cut (割的容量)]
    \[
      \capacity(S, T) = \sum_{u \in S, v \in T, \red{uv \in E}} c(u, v)
    \]
  \end{definition}
\end{frame}
%%%%%%%%%%%%%%%g
...
\begin{frame}{}
  ...
  \vspace{0.50cm}
  \begin{center}
    net flow out of $U$: $f^{+}(U) - f^{-}(U) = \pause
      \sum_{u \in U} (f^{+}(u) - f^{-}(u))$
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%g
...
\begin{frame}{}
  ...
  \pause
  \[
    s \in U \land t \notin U \implies f^{+}(U) - f^{-}(U) = \pause f^{+}(s) = \pause \val(f)
  \]
  \pause
  \[
    s \notin U \land t \in U \implies f^{+}(U) - f^{-}(U) = \pause f^{-}(t) = \pause \val(f)
  \]
\end{frame}
%%%%%%%%%%%%%%%g
...
\begin{frame}{}
  ...
  \pause
  \[
    \blue{\boxed{f^{-}(S) = 0 \land f^{+}(S) = \capacity(S, T)}}
  \]

  \pause
  \[
    \purple{\boxed{\forall e \in [T, S]\; f(e) = 0 \land \forall e \in [S, T]\; f(e) = c(e)}}
  \]
