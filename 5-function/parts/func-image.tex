...
\begin{frame}{}
  \[
    \red{\boxed{y \in f(X) \iff \exists x \in X\; y = f(x)}}
  \]
  \fig{width = 0.35\textwidth}{figs/understand-remember}
  \[
    \red{\boxed{x \in f^{-1}(Y) \iff f(x) \in Y}}
  \]
\end{frame}
...
\begin{frame}{}
  ...
  \]
  \fig{width = 0.35\textwidth}{figs/be-careful}
...
\begin{frame}{}
  ...
  \begin{align}
    ...
    \uncover<4->{\iff & (\exists a \in A_{1}\; b = f(a)) \land
      (\forall a \in A_{2}\; b \neq f(a)) \\[6pt]}
...
\begin{frame}{}
  \begin{theorem}[Properties of $f$ and $f^{-1}$]
    ...
    \begin{enumerate}[(i)]
      \setcounter{enumi}{2}
      \item \purple{$f$ and $f^{-1}$:} \\[8pt]
        \begin{enumerate}[(1)]
          \setlength{\itemsep}{10pt}
          \setcounter{enumii}{8}
            \item $\red{A_0 \subseteq A} \implies A_0 \subseteq f^{-1}(f(A_0))$
