...
\begin{frame}{}
  \begin{definition}[全序关系 (Total Order)]
    如果 $\preceq\; \subseteq X \times X$ 满足以下性质, 则称 $\preceq$ 是 $X$ 上的\red{全序关系}: \\[6pt]
    \begin{description}
      \item[{(1) 自反 (Reflexivity):}]
        \[
...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \begin{definition}[严格全序关系 (Strict Total Order); 线性序 (Linear Order)]
    如果 $\prec\; \subseteq X \times X$ 满足以下条件,
    则称 $\prec$ 是 $X$ 上的\red{严格全序关系}: \\[6pt]
    \begin{description}
