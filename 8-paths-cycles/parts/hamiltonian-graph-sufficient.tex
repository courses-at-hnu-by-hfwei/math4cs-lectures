...
\begin{frame}{}
  \begin{center}
    ...
    \pause
    \vspace{0.30cm}
    Suppose that $G$ meets the \blue{Ore's Condition},
    but $G$ is not \red{Hamiltonian}.
    ...
    \pause
    \vspace{0.80cm}
    Adding edges cannot violate the \blue{Ore's Condition}.

    \pause
    \vspace{0.80cm}
    \red{\it By Extremality.} \\[5pt] \pause
    We can obtain \red{\it maximal} non-Hamiltonian graphs: \\[3pt] \pause
