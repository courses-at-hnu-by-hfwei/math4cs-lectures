...
\begin{frame}{}
  \begin{center}
    Seven Bridges of K\"onigsberg (柯尼斯堡七桥问题)
  \end{center}
...
\begin{frame}{}
  \begin{theorem}[Euler's Theorem]
    A \blue{connected} graph has \red{Eulerian trails} iff
...
\begin{frame}{}
  \begin{theorem}[Euler's Theorem (Carl Hierholzer)]
    A \purple{connected} graph has \red{Eulerian circuits/tours} iff
  ...
  \begin{center}
    \blue{cycle} + \red{cycle} + \cyan{cycle}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%
