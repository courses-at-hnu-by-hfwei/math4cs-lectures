...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \fig{width = 0.45\textwidth}{figs/girl-bijection}
  \begin{center}
    {\it \scriptsize oops, it is not a bijection.}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%
  ...
  \begin{exampleblock}{$|\Q| = |\N|$}
    ...
    \begin{columns}
      \column{0.50\textwidth}
        \fig{width = 0.55\textwidth}{figs/Q-a-b}
      \column{0.50\textwidth}
        \pause
...
\begin{frame}{}
  ...
  \pause
  \[
    a_0 \quad a_1 \quad a_2 \cdots \quad b_0 \quad b_1 \quad b_2 \cdots
  \]

  \pause
  \fig{width = 0.30\textwidth}{figs/does-not-work}
...
\begin{frame}{}
  ...
  \pause
  \vspace{0.50cm}
  \fig{width = 0.30\textwidth}{figs/important}
...
\begin{frame}{}
  ...
  \begin{center}
    ...
    \pause
    \fig{width = 0.16\textwidth}{figs/r-uncountable-01}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%
