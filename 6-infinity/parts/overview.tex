...
\begin{frame}{}
  ...
  \begin{center}
    {\leftpointright\; \purple{Dangerous Knowledge (02:50; BBC 2007)}}
...
\begin{frame}{}
  \begin{columns}
    \column{0.45\textwidth}
      ...
      \vspace{-0.20cm}
      \blue{\centerline{\footnotesize Georg Cantor (1845 -- 1918)}}
    \column{0.45\textwidth}
      \only<5->{
	\fig{width = 0.40\textwidth}{figs/hilbert}
	\vspace{-0.20cm}
	\purple{\centerline{\footnotesize David Hilbert (1862 -- 1943)}}
      }
  \end{columns}
  ...
  \begin{columns}
    ...
    \column{0.30\textwidth}
      ...
      \vspace{-0.50cm}
      \begin{center}
	\red{\footnotesize Leopold Kronecker}
    ...
    \column{0.30\textwidth}
      ...
      \vspace{-0.50cm}
      \begin{center}
	\red{\footnotesize Henri Poincar\'{e}}
    ...
    \column{0.30\textwidth}
      ...
      \vspace{-0.50cm}
      \begin{center}
	\red{\footnotesize Ludwig Wittgenstein}
