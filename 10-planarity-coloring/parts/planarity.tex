...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \pause
      \fig{width = 0.60\textwidth}{figs/hypercube-nonplanar}
    \column{0.50\textwidth}
      \pause
      \fig{width = 0.60\textwidth}{figs/subdivision-k33}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \vspace{-0.60cm}
  \begin{center}
    \teal{\url{https://github.com/courses-at-hnu-by-hfwei/math4cs-lectures/blob/main/10-planarity-coloring/figs/Kuratowski-Petersen.gif}}
  \end{center}
  % \begin{center}
  %   \transduration<0-83>{0}
...
%%%%%%%%%%%%%%%
\begin{frame}{}
  \fig{width = 0.80\textwidth}{figs/planarity-testing-paper}
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.35\textwidth}{figs/tarjan}
    \column{0.50\textwidth}
      \fig{width = 0.40\textwidth}{figs/hopcroft}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{theorem}
    Let $G$ be a simple connected planar graph with
    \red{$n \ge 3$} vertices and $m$ edges. Then
    \[
      m \le 3n -6.
    \]
  \end{theorem}
  ...
  \pause
  \[
    \blue{2m = \Sigma_{f} \deg(f) \ge 3f}
  \]
  \pause
  \begin{center}
    \red{Double Counting the Edges around Faces:} \\[3pt]
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.40\textwidth}
      \pause
      \fig{width = 0.50\textwidth}{figs/K5}
      \[
        m \le 3n -6
      \]
    ...
    \column{0.60\textwidth}
      \pause
      \fig{width = 0.80\textwidth}{figs/K5-Nonplanar-Proof}

      \pause
      \begin{theorem}[Jordan Curve Theorem (1887)]
        \fig{width = 0.40\textwidth}{figs/jordan-curve-theorem}
      \end{theorem}
  \end{columns}

  \pause
  \begin{center}
    \href{https://en.wikipedia.org/wiki/Algebraic\_topology}{Algebraic Topology}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%
