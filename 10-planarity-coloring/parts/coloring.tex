...
\begin{frame}{}
  ...
  \begin{columns}
    ...
    \column{0.50\textwidth}
      \pause
      \fig{width = 0.60\textwidth}{figs/bipartite-graph-no-cycles}
  \end{columns}
...
\begin{frame}{}
  ...
  \vspace{0.80cm}
  \fig{width = 0.60\textwidth}{figs/odd-cycles}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{Lemma}[Characterization of Bipartite Graphs ($\Longleftarrow$)]
    If a graph $G$ does not contain any \purple{odd} cycles,
  ...
  \begin{center}
    ...
    \pause
    \[
      X = \{x \in V(G) : \text{the \blue{distance} from $u$ to $x$ is even}\}
    \]
    \[
      Y = \{y \in V(G) : \text{the \blue{distance} from $u$ to $y$ is odd}\}
    \]

    \pause
    \vspace{-0.30cm}
    \fig{width = 0.40\textwidth}{figs/no-odd-cycle-bipartite}
    \pause
    \vspace{-0.50cm}
    \[
      \purple{u \leadsto v \to v' \leadsto u} \text{ is an \purple{odd} cycle.}
    \]
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \vspace{0.50cm}
  \uncover<3->{
    \fig{width = 0.40\textwidth}{figs/planar}
  }
